...
# ------------------------------------------------------------------------
#
# TITLE - make_survey_halo_samples.py
# AUTHOR - James Lane
# PROJECT - mw-dfs
#
# ------------------------------------------------------------------------
...
'''Draw samples from the halo DFs at the positions of APOGEE stars. Creating 
the halo portion of the survey sample from Lane+ 2021
'''
...
with open(out_dir+'halo_orbits_survey'+oversample_suffix,'wb') as f:
    pickle.dump(halo_orbs,f)
##wi
# noerr orbits just for validation of error addition if interested
with open(out_dir+'halo_orbits_survey_noerr'+oversample_suffix,'wb') as f:
    pickle.dump(halo_orbs_noerr,f)
##wi
with open(out_dir+'halo_actions_survey'+oversample_suffix,'wb') as f:
    pickle.dump(halo_actions,f)
##wi
with open(out_dir+'halo_eELzs_survey'+oversample_suffix,'wb') as f:
